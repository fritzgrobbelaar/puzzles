...
def getSumInvalidIDs(start, end):
    ...
    if len(str(start)) == len(str(end)):
        if len(str(start)) % 2 == 1:
            print(f'Unequal length - so no duplicate IDs found')
            return total
...
assert 99 == getSumInvalidIDs(95, 115)
assert 1010 == getSumInvalidIDs(998, 1012)
...
assert 0 == getSumInvalidIDs(565653,565659)
assert 0 == getSumInvalidIDs(824824821,824824827)
assert 0 == getSumInvalidIDs(2121212118,2121212124)
